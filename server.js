...
client.query('CREATE TABLE IF NOT EXISTS messages(message_id SERIAL PRIMARY KEY, message_text TEXT, slack_ts VARCHAR(40), slack_user_id VARCHAR(40), channel_id VARCHAR(40))');
var query = client.query('CREATE TABLE IF NOT EXISTS channel_user(join_id SERIAL PRIMARY KEY, slack_user_id VARCHAR(40), channel_id VARCHAR(40))');
